...
var extend = function extend2(initOptions) {
...
request$1.use((_0, _1) => __async(this, [_0, _1], function* ({ req: { options }, req }, next) {
...
export { Onion, RequestError, ResponseError, request$1 as default, extend, fetch$1 as fetch };
